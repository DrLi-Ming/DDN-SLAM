...
int main(int argc, char **argv)
{
    ...
    string strFile = string(argv[3])+"/frame";
    ...
    auto trajString = "evaluation/MONO_Replica_"+dataset_name+"_KeyFrameTrajectory";
    auto snapString = "evaluation/MONO_Replica_"+dataset_name+".msgpack";
    auto gtJsonTrajString = "evaluation/MONO_Replica_"+dataset_name+"_gtTraj.json";
