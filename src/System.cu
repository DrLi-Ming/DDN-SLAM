...
System::System(const string &strVocFile, const string &strSettingsFile, const eSensor sensor,
               const bool bUseViewer, const bool bTrainExtrinsicWithPhotometric, const int initFr, const string &strSequence):
    ...
    mbActivateLocalizationMode(false), mbDeactivateLocalizationMode(false), mbShutDown(false)
{
    ...
    if(mStrLoadAtlasFromFile.empty())
    {
        ...
        mpAtlas->ORBEEZMAP(strSettingsFile, strSlamTransform, bTrainExtrinsicWithPhotometric);
    }
    else
    {
        //Load ORB Vocabulary
...
void System::Spin()
{
    ...
    mpAtlas->GetCurrentMap()->StopTraining();
}
...
void System::SaveKeyFrameTrajectoryNGP(const string &filename)
{
    ...
    nlohmann::json scene_config = mpAtlas->GetCurrentMap()->GetSceneConfig();
    ...
    {   
        ...
        */
        ...
        float slice_plane_z, scale, fov, dof;
        mpAtlas->GetCurrentMap()->GetCameraInfo(&slice_plane_z, &scale, &fov, &dof);
...
void System::SaveSnapShot(const string &filename)
{
    ...
    mpAtlas->GetCurrentMap()->SaveSnapShot(filename);
...
void System::SaveMesh(const string &filename, uint32_t marching_cubes_res)
{
    ...
    mpAtlas->GetCurrentMap()->SaveMesh(filename, marching_cubes_res);
...
void System::AddGroundTruthTraj(const std::string& gtTrajPath)
{
    ...
    mpAtlas->GetCurrentMap()->AddGroundTruthTraj(gtTrajPath);
}
